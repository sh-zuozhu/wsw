...
<div id="navbar" class="navbar navbar-default">
	<script type="text/javascript">
		try {
			ace.settings.check('navabar', 'fixed');
		} catch (e) {
		}
	</script>
			...
			<ul class="nav ace-nav">
				<li class="grey"><a data-toggle="dropdown"
					class="dropdown-toggle" href="#"> <i
						class="ace-icon fa fa-tasks"></i> <span class="badge badge-grey"></span>
				</a>
					...
					<ul
						...
						<li class="dropdown-footer"><a href="javascript:">
								备用(这只是个图标按钮而已) <i class="ace-icon fa fa-arrow-right"></i>
						</a></li>
					</ul>
			   </li>
			   ...
			   <li class="light-blue">
				...
				<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
					<li>
						<a onclick="editPhoto();" style="cursor:pointer;"><i class="ace-icon glyphicon glyphicon-picture">修改头像</a>
					</li>
					<li>
